...
get_latest_version() {
    ...
    latest_release=$(curl -s https://api.github.com/repos/fanguohao/cursor/releases/latest) || {
...
install_cursor_free_vip() {
    ...
    local download_url="https://github.com/fanguohao/cursor/releases/download/v${VERSION}/${binary_name}"
    ...
    if curl --output /dev/null --silent --head --fail "$download_url"; then
        ...
        if [[ "$OS" == "mac_arm64" || "$OS" == "mac_intel" ]]; then
            ...
            download_url="https://github.com/fanguohao/cursor/releases/download/v${VERSION}/${binary_name}"
            ...
            OS="linux"
            binary_name="CursorFreeVIP_${VERSION}_${OS}"
            download_url="https://github.com/fanguoaho/cursor/releases/download/v${VERSION}/${binary_name}"
            echo -e "${CYAN}ℹ️ New download link: ${download_url}${NC}"
